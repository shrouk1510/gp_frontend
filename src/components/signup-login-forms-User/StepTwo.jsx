        ...
        <div className="container1sign">
            ...
            <div className="inputssign">
                <div className="inputsig inputsign">
                    <input type="text" placeholder="First Name" name="firstname" value={userData.firstname} onChange={handleChange} required />
                </div>

                <div className="inputsig inputsign">
                    <input type="text" placeholder="Last Name" name="lastname" value={userData.lastname} onChange={handleChange} required />
                </div>
            ...
            <div className="buttons-containersign">
                ...
                <Link to='/Submit' className="submit-buttonsign" onClick={handleSubmit}>Submit</Link>
            </div>
        </div>
    );
};
